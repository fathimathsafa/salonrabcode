                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              "Add New Service",
                              style:TextStyle(
                                color: ColorTheme.white,fontSize: 23.sp,fontWeight: FontWeight.bold
                              ),
                            ),
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: Icon(Icons.volunteer_activism,color: ColorTheme.white,),
                      ...
                      Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            icon: Icon(Icons.keyboard_arrow_down,color: ColorTheme.white,),
                            iconSize: 24.h,
                            elevation: 1,
                            style: TextStyle(
                              color:ColorTheme.white,
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle:TextStyle(color: ColorTheme.white),
                            prefixIcon: Icon(Icons.attach_money,color: ColorTheme.white,),
                            border: InputBorder.none, // Removes the default border
                          ),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
